      ...
      <div className="iphone:mx-5 lg:ml-[90px] lg:mr-[90px] mt-5">
        <Row gutter={[32, 0]} className="">
          ...
          >
            ...
            <div className="homePage-featured_book p-[35px] border-solid border-[1px] border-t-0 max-h-[500px] overflow-y-auto">
                ...
                .map((item, index) => (
                  ...
                  >
                    <div className="homepage-product z-50 relative max-h-[500px] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3xl border-t-0 hover:border-t-1 hover:border">
                      ...
                      <div className="iphone:text-white cursor-pointer lg:-translate-x-1/2 iphone:m-auto left-2/4 lg:-z-50 lg:absolute bottom-[73px] max-w-[157px] w-full ">
