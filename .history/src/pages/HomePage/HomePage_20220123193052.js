...
const HomePage = (props) => {
  ...
  return (
    <div>
      <div className="iphone:mx-5 desktop:ml-[90px] desktop:mr-[90px] mt-5">
        <Row gutter={[32, 0]} className="">
          <Col
            span={6}
            className="iphone:!max-w-[100%] iphone:!flex-1 desktop:!max-w-[25%] desktop:!flex-ant"
          >
            <div className=" p-[35px] border-solid border-[1px]">
              <h3 className="flex justify-between items-center text-desktop">
                Categories
                {plusCategories ? (
                  <PlusOutlined
            ...
            >
              <h3 className="flex justify-between items-center text-desktop mb-4 ">
                Featured Books
                {plusFeatured ? (
                  <PlusOutlined
                    className="text-base text-black cursor-pointer"
          ...
          <Col
            span={18}
            className="iphone:!flex-flexIphone iphone:!max-w-[100%] md:!flex-ant100 md:!max-w-[100%] desktop:!flex-ant75 desktop:!max-w-[75%] mb-1"
          >
            ...
            <Row className="">
              {datas
                ...
                .map((item, index) => (
                  ...
                  desktop:!max-w-[25%] desktop:!flex-ant"
                  >
                    <div className="homepage-product z-50 relative max-h-[500px] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3xl border-t-0 hover:border-t-1 hover:border">
                      ...
                      <div className="homepage-product-item_content ease-out duration-150 text-[16px] mb-1 pt-4 max-h-28 bg-white">
                        <h2 className="mb-0 cursor-pointer h-12 line-clamp-2 inline-block">
                          {item.title}
                        </h2>
                        <p className="text-[#7c6e65] text-[14px] mb-1 hover:text-[#f75454] cursor-pointer inline-block">
                          {item.description}
                        </p>
                      ...
                      <div className="iphone:text-white desktop:text-black cursor-pointer desktop:-translate-x-1/2 iphone:m-auto iphone:translate-y-4 desktop:translate-y-0 left-2/4 desktop:-z-50 desktop:absolute bottom-[73px] max-w-[157px] w-full ">
                        <ShoppingOutlined className="homePage_button  desktop:bg-white iphone:bg-primary p-3 rounded ease-in-out duration-100 hover:bg-[#f75454] hover:text-white text-2xl desktop:absolute w-full desktop:-translate-x-1/2	desktop:left-2/4"></ShoppingOutlined>
                      </div>
                    </div>
                  </Col>
                ))}
