                  ...
                  >
                    <div className="homepage-product z-50 relative max-h-[500px] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3xl border-t-0 hover:border-t-1 hover:border">
                      ...
                      <div className=" cursor-pointer lg:-translate-x-1/2 iphone:m-auto left-2/4 lg:-z-50 lg:absolute bottom-[73px] max-w-[157px] w-full ">
                        <ShoppingOutlined className="homePage_button md:bg-white iphone:bg-primary p-3 rounded ease-in-out duration-100 hover:bg-[#f75454] hover:text-white text-2xl lg:absolute w-full lg:-translate-x-1/2	lg:left-2/4"></ShoppingOutlined>
                      </div>
                    </div>
                  </Col>
                ))}
