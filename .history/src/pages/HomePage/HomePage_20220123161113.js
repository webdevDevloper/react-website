            ...
            <Row className="">
              {datas
                ...
                .map((item, index) => (
                  ...
                  >
                    <div className="homepage-product z-50 relative max-h-[400px] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3xl border-t-0 hover:border-t-1 hover:border">
                      <div className="p-1">
                        <img
                          src={item.imageUrl}
                          alt=""
                          className="max-w-full w-full cursor-pointer h-[200px] object-cover"
                        />
                      </div>
                      ...
                      <div className="cursor-pointer lg:-translate-x-1/2 iphone:m-auto left-2/4 lg:-z-50 lg:absolute bottom-[75px] max-w-[157px] w-full ">
