                ...
                .map((item, index) => (
                  ...
                  >
                    <div className="homepage-product z-50 relative max-h-[500px] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3xl border-t-0 hover:border-t-1 hover:border">
                      ...
                      <div className="iphone:text-white cursor-pointer lg:-translate-x-1/2 iphone:m-auto iphone:translate-y-4 lg:translate-y-5 left-2/4 lg:-z-50 lg:absolute bottom-[73px] max-w-[157px] w-full ">
