                ...
                .map((item, index) => (
                  ...
                  >
                    <div className="homepage-product z-50 relative max-h-[500px] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3xl border-t-0 hover:border-t-1 hover:border">
                      ...
                      <div className="homepage-product-item_content ease-out duration-150 text-[16px] mb-1 pt-4 max-h-28 bg-white hover:text-[#f75454]">
                        <h2
                          className="mb-0 cursor-pointer h-12 line-clamp-2 inline-block"
                          onClick={navigateProduct}
                        >
                          {item.title}
                        </h2>
