...
const AdminPage = () => {
  ...
  // const filterInput
  className="px-[15px] py" = document.querySelector(".filter");
  // let updateId = null;
  // // git clone
  ...
  // filterInput
  className="px-[15px] py".addEventListener(
  //   "keydown",
  ...
  return (
    <div>
      <div className="my-3 mx-4 border-2 border-solid rounded-md">
          ...
          <Row>
            ...
            <Col span={8}>
              <div>
                ...
                <input
                className="px-[15px] py" type="checkbox" name="bestSeller" id="best-seller" />
              </div>
            </Col>
            <Col span={8}></Col>
            <input
        ...
        <input
        className="px-[15px] py" type="text" className="filter" name="filter" />
