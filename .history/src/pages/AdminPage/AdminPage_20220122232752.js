        ...
        <div>
          <Row>
            {datas.map((item) => (
              ...
              >
                <div className="homepage-product z-50 relative max-h-[100%] p-[30px] border-solid border-[1px] hover:border-black hover:shadow-3x hover:border-t-1 hover:border">
                  <img
                    src={item?.image}
                    alt=""
